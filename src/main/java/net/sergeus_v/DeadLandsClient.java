...
public class DeadLandsClient implements ClientModInitializer {
		...
		public void onInitializeClient()
		{
			...
			initBloodRender(mod.STILL_BLOOD, mod.FLOWING_BLOOD, new Identifier("deadlands", "blood"), new Color(194, 149, 8).getRGB());
	        BlockRenderLayerMap.INSTANCE.putFluids(RenderLayer.getTranslucent(), mod.STILL_BLOOD, mod.FLOWING_BLOOD);
	    }
